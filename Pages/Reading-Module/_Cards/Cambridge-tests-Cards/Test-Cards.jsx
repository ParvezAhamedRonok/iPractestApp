...
export default function Cambridge_Test_Cards() {
    ...
    useEffect(() => {
        ...
        // axios.get(`https://node-js-express-login-example.onrender.com/api/user/AllReadingResults/${userEmail}`, {
        //     headers: {
    ...
    const goBackListeningTest = (testNumber, testSeries) => {
        navigation.push(`Reading-Module/Reading-Tests-Section/Cambridge-${testSeries}-Test${testNumber % 4 === 0 ? 4 : testNumber % 4}`)
        // navigation.navigate('Reading-Tests-Section', {
    ...
    const UI_Array = tests.flatMap(({ series, start, image }, index) =>
        Array.from({ length: 4 }, (_, i) => {
            ...
            return {
                ...
                Reviews: `(${Math.floor(Math.random() * 100) + 2} reviews)`,
