...
const ServicesListeningAllTest = () => {
  ...
  useEffect(() => {
    // axios({
    //   method: 'get',
    //   url: 'https://node-js-express-login-example.onrender.com/api/user/AllListeningResults/abc1234@gmail.com',
    //   headers: {
        ...
        <TouchableOpacity key={index} style={styles.card}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.bottomRow}>
              ...
              <TouchableOpacity onPress={() => navigation.push(`Listening-Module/Listening-Tests-Section/${test.section}`)}>
                <LinearGradient
...
export default ServicesListeningAllTest;
