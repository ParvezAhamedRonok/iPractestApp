...
import TranscriptPage from "../All-Tests/Test-Transcripts"
...
const Footer = ({ AnswersData }) => {
  ...
  const handleTranscriptPage = () => {
    ...
    // Alert.alert('Transcript' , "transcript page is opening right ");
  ...
  return (
    <>
      <View style={styles.footerSection}>
        <View style={styles.row}>
          ...
          <View style={styles.buttons}>
            ...
            <TouchableOpacity style={styles.buttonPurple} onPress={handleTranscriptPage}>
              <Text style={styles.btnText}>Transcript</Text>
            </TouchableOpacity>
      ...
      {
        toggleTranscript && <TranscriptPage
        setOpenTranscripts={setToggleTransCript}
        />
      }
    </>
