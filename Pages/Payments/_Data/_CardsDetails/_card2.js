    ...
    <View className="slider" style={styles.cardWrapper}>
      ...
      <View style={styles.courseDetails}>
        <View style={styles.courseBadge}>
          <Text style={styles.courseBadgeText}>Expert  Package</Text>
        </View>
        <Text style={styles.courseDescription}>
          Perfect for dedicated learners aiming to improve their IELTS scores with full access to our resources.
        </Text>
        <Text style={styles.price}>
          ...
          {userPaymentStatusCheck === "Starter"
            ? userCountry === "Bangladesh"
              ? 200
              : asianCountries.includes(userCountry)
                ? 2
                : 3
            : userCountry === "Bangladesh"
              ? 487
      ...
      <View style={styles.featuresSection}>
        ...
        <View style={styles.featureItem}>
          ...
          <Text style={styles.featureText}><Text style={styles.bold}>40+ Speaking Mock Test</Text> </Text>
        </View>
        ...
        <View style={styles.featureItem}>
          <Icon name="lightbulb-o" size={16} color="#000" />
          <Text style={styles.featureText}><Text style={styles.bold}>400+  Writing Evaluation and Mock Test</Text> </Text>
        </View>

        <View style={styles.featureItem}>
          <Icon name="lightbulb-o" size={16} color="#000" />
          <Text style={styles.featureText}><Text style={styles.bold}>400+  Writing Feedback</Text> </Text>
        </View>
      ...
      <TouchableOpacity style={styles.bookButton} onPress={() => {
        let amount = userPaymentStatusCheck == "Starter" ? 200 : 487;
        passDataFunc('Expert', amount, "Paypal")
      }}>
...

      {
        userCountry != "Bangladesh" && <TouchableOpacity style={styles.bookButton} onPress={() => {
          let amount = userPaymentStatusCheck == "Starter" ? 200 : 487;
          passDataFunc('Expert', amount, "Stripe")
        }}>
          <Text style={styles.bookButtonText}> {
